...
//-----------------------------------------------------------------------------
// Sets the pins to be used for voltage and current 
// sensors based on emontx pin map
//-----------------------------------------------------------------------------
...
void EnergyMonitor::calcVI(unsigned int crossings, unsigned int timeout)
{
 ...
 unsigned int crossCount = 0; // Number of times threshold is crossed.
 ...
 unsigned long start = millis(); // Loop time counter

 while (st == false)		// the while loop...
 {
  startV = analogRead(inPinV);	// using the voltage waveform
  if ((startV < (ADC_COUNTS * 0.55))
