...
// determined by procedure described under
//  "Calibrating the internal reference voltage" at
...
private:
 ...
 //-------------------------------------------------------------------------
 int sampleV;		// Holds the raw analog read value
 int sampleI;                     

 double lastFilteredV,filteredV; // Raw analog value minus the DC offset
 double filteredI;                  
 ...
 double sqV,sumV;		// sq = squared
 double sqI,sumI;		// sum = Sum
 double instP,sumP;		// inst = instantaneous

 int startV; // Instantaneous voltage at start of sample window.

 boolean lastVCross, checkVCross; // Times threshold is crossed.
};
